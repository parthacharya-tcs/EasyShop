  ...
  return (
    <div className="flex h-full w-full flex-col">
      ...
      <div className="flex min-h-0 grow">
        <div className="custom-scroll no-scrollbar h-full w-full max-w-[28%] rounded-bl-xl bg-gray-50">
        ...
        <div id="filter-options" className="custom-scroll flex-1 py-2 pl-4">
