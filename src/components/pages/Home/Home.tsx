...
const Home = () => {
  return (
    <div className="flex h-full w-full flex-col text-xl">
      <Header />
      <main className="custom-scroll grow">
        ...
        <section className="px-4">
          <HeaderLink heading="Shop by Category" subHeading="View all" to="/categoryFilter" />
          <CategoryList />
        </section>

        <section className="my-5 px-4">
          <HeaderLink heading="Products For you" subHeading="View all" to="/not" />
          <NProductList />
        </section>
      </main>
      <Footer />
