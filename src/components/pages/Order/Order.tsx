  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <main className="flex grow flex-col overflow-hidden">
        <section className="shrink-0 relative z-0 mx-auto flex w-full max-w-[80%] overflow-hidden rounded-full border border-gray-200 text-center text-white">
          <button
        ...
        <section className="custom-scroll grow px-3 py-5">
          {tab === 1 ? (
